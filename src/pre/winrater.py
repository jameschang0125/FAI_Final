...
class winRater():
    def __init__(self, loadpath = "src/pre/res/wr5_100k.pickle"):
        if loadpath: 
    ...
    @classmethod
    def allWR(self, v = 1, dumppath = "src/pre/res/wr5.pickle", **kwargs):
        '''
    ...
    @classmethod
    def paraWR(self, v = 0, dumppath = "src/pre/res/wr5.pickle", workers = 70, **kwargs):
        '''
