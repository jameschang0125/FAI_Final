from src.pre.realtime_processer import RealtimeProcesser as RP
from src.eqcalc.research import researcher as RS
from itertools import product
from src.eqcalc.state import State
from src.pre.equireader import Equireader as EQ
from src.eqcalc.search import searcher as SS # hs2s

import numpy as np

def testeq():
    eqold = EQ(eqpath = "src/pre/res/eq.pickle")
    eq = EQ()
